  ...
  return (
    <div style={{ maxWidth: 1100, margin: '0 auto', padding: '28px 20px' }}>
      <div style={{ marginBottom: 24 }}>
        <h1 style={{ fontSize: 26, fontWeight: 700, color: 'var(--text-primary)', marginBottom: 4 }}>총력전</h1>
        <p style={{ fontSize: 17, color: 'var(--text-secondary)', marginBottom: 16 }}>시즌별 보스 및 유저 기록 통계</p>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    <span style={{ fontSize: 14, fontWeight: 600, color: 'var(--text-muted)', letterSpacing: '0.05em', textTransform: 'uppercase' }}>
                      총력전
                    </span>
                    {isCurrent && (
                      <span style={{ fontSize: 13, fontWeight: 700, padding: '2px 6px', borderRadius: 3, background: 'var(--accent)', color: '#fff', letterSpacing: '0.03em' }}>
                        진행중
                      </span>
                    )}
                  </div>
                ...
                <div style={{ marginBottom: 12 }}>
                  <div style={{ fontSize: 16, fontWeight: 600, color: 'var(--accent)', marginBottom: 2 }}>
                    S{season.season}
                  </div>
                  <div style={{ fontSize: 21, fontWeight: 700, color: 'var(--text-primary)', lineHeight: 1.2 }}>
                    {boss?.nameKo ?? '—'}
                  </div>
                </div>
...
function TerrainBadge({ terrain }: { terrain: string }) {
  ...
  return (
    <span style={{ fontSize: 14, fontWeight: 600, padding: '2px 7px', borderRadius: 4, background: style.bg, color: style.color }}>
      {style.label}
    </span>
  )
}
